...
// FLIGHT CONTROL TASK
constexpr uint8_t TASK_FLIGHT_CONTROL_PRIORITY = 3;             // Priority of the flight control task
constexpr uint8_t TASK_FLIGHT_CONTROL_QUEUE_DEPTH_OBJS = 10;    // Size of the flight control task queue
constexpr uint16_t TASK_FLIGHT_CONTROL_STACK_DEPTH_WORDS = 512; // Size of the flight control task stack
